...
export class Contactus implements OnInit{
 ...
 title="Contact Form";
  ...
  inquiryTypes = [
    ...
    'Job seeker - I have a question about job applications or working at Accenture.',
    'Ecosystem partner - I want to explore ecosystem partnership opportunities with Accenture',
    'Investor - I want to contact Investor Relations.',
    'Media - I have a media or press-related question, including requests for interviews and official information.',
    'Supplier or vendor - I need help with invoices, payments, contracts, registration or other issues.',
